...
for f in ['v062-network-faults.sh','v062-watchdog-mock.sh','v062-loader-failure-mock.sh']:
...
need("version=='v0.6.2'" in payload and "b'routing: critical rule failed:'" in payload and "b'OURFW_WATCHDOG_ONESHOT'" in payload,'final payload verifier does not enforce v0.6.2 fixes')
