#!/usr/bin/env python3
"""Enable the minimal stock Linux 3.4 TPROXY/socket pieces for EC220.

This helper carries the configuration proven by the dedicated TPROXY research
build into the v0.7 integration branch.
"""
...
def main() -> int:
    ...
    # IP_NF_MANGLE and NETFILTER_ADVANCED.
    ...
    print(
        "EC220 TPROXY config enabled: EXPERIMENTAL=y, NETFILTER_ADVANCED=y, "
        "IP_NF_MANGLE=m, NETFILTER_TPROXY=m, xt_TPROXY=m, xt_socket=m"
    )
    return 0
