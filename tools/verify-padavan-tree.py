...
def main():
    ...
    for k in ['CONFIG_FIRMWARE_ENABLE_IPV6','CONFIG_FIRMWARE_INCLUDE_IPSET','CONFIG_FIRMWARE_INCLUDE_SHORTCUT_FE','CONFIG_FIRMWARE_INCLUDE_DROPBEAR','CONFIG_FIRMWARE_INCLUDE_WIREGUARD','CONFIG_FIRMWARE_INCLUDE_AMNEZIAWG','CONFIG_FIRMWARE_INCLUDE_NFQWS','CONFIG_FIRMWARE_INCLUDE_HTTPS','CONFIG_FIRMWARE_INCLUDE_SFTP','CONFIG_FIRMWARE_INCLUDE_OPENVPN','CONFIG_FIRMWARE_INCLUDE_OPENSSL_EC','CONFIG_FIRMWARE_INCLUDE_OPENSSL_EXE','CONFIG_FIRMWARE_INCLUDE_ZRAM','CONFIG_FIRMWARE_INCLUDE_CURL','CONFIG_CC_OPTIMIZE_FOR_SIZE']:
